...
class Help(commands.Cog):
    ...
    async def amongushelp(self, ctx):
        ...
        embed.add_field(name="Remove permission", value=".remove @name perm", inline=True)
        embed.add_field(name="Roll Dice", value=".roll ndn (e.g. 1d4)", inline=True)
        embed.add_field(name="Rename channel to code", value=".code code (e.g. YTNMAQ)", inline=True)
